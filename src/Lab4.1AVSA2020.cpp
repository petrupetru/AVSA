...
int main(int argc, char ** argv)
{
	...
	string dataset_path = "/home/eps/Downloads/AVSA_LAB1_dataset2012lite/dataset2012lite/dataset"; //SET THIS DIRECTORY according to your download
...
//
//	string dataset_path = "/home/eps/Downloads/AVSASlidesVideos_dataset"; //SET THIS DIRECTORY according to your download
...
// if (argc==3)	{input=argv[3]);}
	...
	string project_root_path = "/home/eps/eclipse-workspace"; //SET THIS DIRECTORY according to your project
	string project_name = "Lab1.3AVSA2020"; // project exe name
...
//			namedWindow("ForeGround Mask"); // final fgmask
			...
			//fgseg::bgs avsa_bgs(tau, rgb, alpha, threshold_ghosts2, width, height); //construct object of the bgs class
			//Lab1.1.2 fgseg::bgs avsa_bgs(tau, alpha, selective_bkg_update, rgb); //construct object of the bgs class
			fgseg::bgs avsa_bgs(tau, rgb, threshold_ghosts2, alpha4); //construct object of the bgs class
